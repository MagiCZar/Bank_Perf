...
<html>
<head>
    <title>个人业务考核指标显示</title>
    <script type="text/javascript" src="js/中间业务指标设定.js" ></script>
    <script>
...
<div>
    <table border="1" style="width:80%;margin:0 auto;height :40px;text-align: center">
        <caption>
            <span style="color: #FF0000">个人业务</span>考核指标
        </caption>
        <%--HeadLine  7columns--%>
        <tr>
            <th>考核项目</th>
        ...
        <tr>
            ...
            <td  width="300px" rowspan="3">个人负债业务</td>
